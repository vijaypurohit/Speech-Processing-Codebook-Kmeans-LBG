// Speech Processing - Kmeans.cpp : Defines the entry point for the console application.
/******************************************************************************************************************************************
	Speech Processing CS 566: Assignment 04 (KMeans)
...
double tok_distances[codeBkSize];							//calculating tokhura distance of vector x with each vector y in codebook Y
...
const char fileNameConsole[] = "kmeans_output.txt";								
...
void DisplayCommonSettings(){
	// General Information to Display
		printf("****-------- WELCOME TO VECTOR QUANTIZATION (Kmeans) --------****\n");		
		...
		//printing in file
		fprintf(fp_console,"****-------- WELCOME TO VECTOR QUANTIZATION (Kmeans) --------****\n");		
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	/**************** Applying Kmeans Algorithm/Generaliszed LLoyd's Algorithm ****************/
	printf("\n\t---------------------- Starting K Means Algo ----------------------\n\n"); fprintf(fp_console, "\n\t---------------------- Starting K Means Algo ----------------------\n"); 
	 kmeans_algo(codeBkSize);
	printf("\n\t---------------------- Ending K Means Algo ----------------------\n"); fprintf(fp_console, "\n\t---------------------- Ending K Means Algo ----------------------\n");
